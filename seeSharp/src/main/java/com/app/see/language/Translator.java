 ...
 */
package com.app.see.language;

import android.app.Activity;
import android.content.SharedPreferences;
import android.preference.PreferenceManager;

import com.app.see.CaptureActivity;
import com.app.see.PreferencesActivity;
...
public class Translator {
  ...
  static String translate(Activity activity, String sourceLanguageCode, String targetLanguageCode, String sourceText) {   
    ...
    if (api.equals(PreferencesActivity.TRANSLATOR_BING)) {
      ...
      return null;//TranslatorGoogle.translate(sourceLanguageCode, targetLanguageCode, sourceText);
    }
